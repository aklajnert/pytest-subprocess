...
class Process:
    ...
    def __init__(self):
        self.processes: typing.Dict[typing.Union[str, typing.Tuple[str]], FakePopen] = dict()

    def register_subprocess(self, command: typing.Union[typing.List[str], typing.Tuple[str], str]):
